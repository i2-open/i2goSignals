...
*/
func CreateSetForStream(subject *EventSubject, streamConfig ssef.StreamConfiguration) SecurityEventToken {
...
func (set *SecurityEventToken) AddEventPayload(eventUri string, claims map[string]interface{}) {
	set.Events[eventUri] = claims
}
