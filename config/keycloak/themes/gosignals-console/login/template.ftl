...
<div class="${properties.kcLogin!}">
  <div class="${properties.kcLoginContainer!}">
    <#--
      Keycloak 26 / PF v5 layout: rendering an outer header here positions it as a side column
      on wide screens (appearing to the right of the form). We suppress the outer header entirely
      so that only the title area inside <main> is used. The theme's login.ftl should render any
      header content via the "header" section which is nested into #kc-page-title below.
    -->
