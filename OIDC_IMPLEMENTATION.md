...
3. adminUI redirects to Keycloak (http://localhost:9080/realms/gosignals)
...
### goSignalsServer
- `KEYCLOAK_URL`: Keycloak realm URL (default: http://localhost:9080/realms/gosignals)

### adminUI (Vite)
- `VITE_KEYCLOAK_URL`: Keycloak realm URL (default: http://localhost:9080/realms/gosignals)
