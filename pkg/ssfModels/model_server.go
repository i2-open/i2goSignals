...
type Server struct {
	...
	TLSSkipVerify       bool   `json:"TLSSkipVerify,omitzero"`   // If true, skip certificate verification (not recommended for production)
	...
	StrictSsf bool `bson:"strictSsf,omitempty" json:"strictSsf,omitzero"`
}
