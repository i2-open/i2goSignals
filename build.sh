...
if [ "$multi" = 'Y' ];then
   ...
   do
     ...
     CGO_ENABLED=0 GOOS=linux GOARCH=$arch go build -o ./${BIN_DIR}/goSignals ./cmd/goSignals/...
     CGO_ENABLED=0 GOOS=linux GOARCH=$arch go build -o ./${BIN_DIR}/goSignalsServer ./cmd/goSignalsServer/...
     CGO_ENABLED=0 GOOS=linux GOARCH=$arch go build -o ./${BIN_DIR}/goSsfServer ./cmd/goSsfServer/...
     CGO_ENABLED=0 GOOS=linux GOARCH=$arch go build -o ./${BIN_DIR}/cluster-monitor ./cmd/cluster-monitor/...
     CGO_ENABLED=0 GOOS=linux GOARCH=$arch go build -o ./${BIN_DIR}/genTlsKeys ./cmd/genTlsKeys/...
     CGO_ENABLED=0 GOOS=linux GOARCH=$arch go build -o ./${BIN_DIR}/healthcheck ./cmd/healthcheck/...
  ...
  CGO_ENABLED=0 GOOS=linux go build -o ./${BIN_DIR}/goSignals ./cmd/goSignals/...
  CGO_ENABLED=0 GOOS=linux go build -o ./${BIN_DIR}/goSignalsServer ./cmd/goSignalsServer/...
  CGO_ENABLED=0 GOOS=linux go build -o ./${BIN_DIR}/goSsfServer ./cmd/goSsfServer/...
  CGO_ENABLED=0 GOOS=linux go build -o ./${BIN_DIR}/cluster-monitor ./cmd/cluster-monitor/...
  CGO_ENABLED=0 GOOS=linux go build -o ./${BIN_DIR}/genTlsKeys ./cmd/genTlsKeys/...
  CGO_ENABLED=0 GOOS=linux go build -o ./${BIN_DIR}/healthcheck ./cmd/healthcheck/...
